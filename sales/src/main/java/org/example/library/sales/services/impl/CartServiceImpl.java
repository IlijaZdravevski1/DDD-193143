...
public class CartServiceImpl implements CartService {
    ...
    private final MovieService bookService;
    ...
    @Override
    public boolean addBookToCart(CartId cartId, MovieId bookId) {
    ...
    @Override
    public boolean removeBookFromCart(CartId cartId, MovieId bookId) {
        return this.cartRepository.findById(cartId)
                .map(cart -> {
